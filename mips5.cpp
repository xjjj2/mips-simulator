...
atomic<bool> ready[6] = { 0 };
atomic<int> usingreg[34] = { 0 };
mutex con_lock[6];
condition_variable cv[6];
atomic<bool> finish[6] = { false };
atomic<bool> conlock[6] = { 0 };
mutex uc;
mutex _lock[6];
atomic<bool> stall[6] = { 0 };
atomic<bool> haltlock=false;
atomic<bool> volatile readed[6] = { false };
int halt = 0;
